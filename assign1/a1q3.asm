...
;Answer: You cannot use the lpm from register to register but you can use it from a varible to register. 
;		 Yes st can be used to store data from any registers. 
;-------------------------
; Your code goes here:
;
;	add r1,r2
